                        ...
                        <div class="header-ctn">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="cart-dropdown">
                                    <div class="cart-list">
                                        {{-- @foreach (auth()->user()->favorites as $wishlist)
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="{{$wishlist->product->img ?? "./img/product02.png"}}" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">{{$wishlist->product->name}}</a></h3>                                            </div>
                                            <button onclick="toggleCart({{$wishlist->product_id}})" class="delete"><i class="fa fa-close"></i></button>
                                        </div>
                                        @endforeach --}}
                                    </div>
                                </div>
